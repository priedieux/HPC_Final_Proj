#!/bin/bash
# benchmark.sh - Run comprehensive benchmarks for image processing

echo "======================================"
echo "Image Processing OpenMP Benchmark"
echo "======================================"
...
with open('results/benchmark_results.txt', 'r') as f:
    content = f.read()
...
with open('results/benchmark_results.txt', 'a') as f:
    f.write('\n\n')
    for line in output_lines:
        f.write(line + '\n')

print("\nSpeedup metrics added to results/benchmark_results.txt")
EOF
